...
│   └── outputs/   # optional generated parquet publication exports
├── scripts/
│   ├── fetch_raw_data.py
...
7. Wait for the workflow to finish and push generated parquet files under `data/cache/` and `data/outputs/`.
